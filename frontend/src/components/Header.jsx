...
const Header = () => {
  ...
  return (
    <>
      {/* Combined Headers */}
      <div className="sticky top-0 z-50 font">
              ...
              {isAuthenticated && (
                <>
                  ...
                  <div className="relative flex items-center space-x-3">
                    {/* User Avatar */}
                    <div className="w-10 h-10 flex items-center justify-center bg-green-700 text-white font-bold rounded-full cursor-pointer shadow-md">
                      {userInitials}
                    </div>
                    ...
                    <svg
                      ...
                      className={`w-5 h-5 ml-3 text-gray-700 cursor-pointer transition-transform duration-300 ${
              ...
              <nav className="flex flex-col items-center space-y-4 py-4">
                ...
                {isAuthenticated && (
                  <>
                    ...
                    <div className="px-6 py-3 text-gray-700 text-center">{userEmail}</div>
                  </>
                )}
              </nav>
            </div>
