...
function PortalGuide() {
  return (
    <div>
      <section id="works" className="relative py-10 sm:py-16 lg:py-24 font pb-20"> {/* Added pb-20 for bottom padding */}
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-4xl text-dark font-extrabold mx-auto md:text-6xl lg:text-5xl">
              How does it work?
            </h2>
          ...
          <div className="relative mt-12 lg:mt-20">
            ...
            <div className="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-12">
              ...
              <div>
                ...
                <p className="mt-4 text-base text-gray-600 md:text-lg">
                  Navigate to the Profile section and fill in all the required details and information. Keeping your profile updated ensures a smooth and successful job application process.
                </p>
              </div>
              <div>
                <div className="flex items-center justify-center w-16 h-16 mx-auto bg-white border-2 border-green-700 rounded-full shadow">
