    ...
    <div className="p-6 bg-white rounded-lg shadow-md w-full overflow-hidden">
      ...
      {education.length > 0 ? (
        education.map((edu, index) => {
          ...
          return (
            <div key={edu.id} className="overflow-hidden">
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-8">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start">
                    ...
                    <span className="text-sm text-gray-600 flex-1 break-words">{edu.school_name}</span>
                  </div>
                  <div className="flex items-start">
                    <strong className="text-sm text-gray-700 w-40">Year Completed:</strong>
                    <span className="text-sm text-gray-600 flex-1 break-words">{edu.year_completed}</span>
                  </div>
                  <div className="flex items-start">
                    <strong className="text-sm text-gray-700 w-40">Grade:</strong>
                    <span className="text-sm text-gray-600 flex-1 break-words">{edu.high_school_grade}</span>
                  </div>
                  <div className="flex items-start">
                    <strong className="text-sm text-gray-700 w-40">Activities:</strong>
                    <span className="text-sm text-gray-600 flex-1 break-words">{edu.high_school_activities}</span>
                  </div>
                </div>
                {/* University Details */}
                <div className="space-y-3">
                  ...
                  <div className="flex items-start">
                    ...
                    <span className="text-sm text-gray-600 flex-1 break-words">{edu.university_name}</span>
                  </div>
                  <div className="flex items-start">
                    <strong className="text-sm text-gray-700 w-40">Degree Program:</strong>
                    <span className="text-sm text-gray-600 flex-1 break-words">{edu.degree_program}</span>
                  </div>
                  <div className="flex items-start">
                    <strong className="text-sm text-gray-700 w-40">Field of Study:</strong>
                    <span className="text-sm text-gray-600 flex-1 break-words">{edu.field_of_study}</span>
                  </div>
                  <div className="flex items-start">
                    <strong className="text-sm text-gray-700 w-40">University Grade:</strong>
                    <span className="text-sm text-gray-600 flex-1 break-words">{edu.university_grade}</span>
                  </div>
                  <div className="flex items-start">
                    <strong className="text-sm text-gray-700 w-40">Start Date:</strong>
                    <span className="text-sm text-gray-600 flex-1 break-words">{edu.start_date}</span>
                  </div>
                  <div className="flex items-start">
                    <strong className="text-sm text-gray-700 w-40">End Date:</strong>
                    <span className="text-sm text-gray-600 flex-1 break-words">{edu.end_date}</span>
                  </div>
                </div>
              </div>
